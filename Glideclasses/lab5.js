...
var gr_inc = new GlideRecord('incident');
 ...
 gr_inc.addEncodedQuery('active=true^state=2');
 gr_inc.addJoinQuery('task_sla','sys_id','task')
 
 gr_inc.query()
 
 while(gr_inc.next()){
    gs.info('Incident: ' + gr_inc.number + 'SLA Stage:' + gr_inc.state.getDisplayValue());
 }